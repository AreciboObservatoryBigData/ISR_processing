#!/usr/bin/python3.7
#run it on patillas or gpuserv0 NOT skittles
import os
import glob
import subprocess
# testing
...
dir_failed_path = 'outputs/verification_results/failed_dir_list.txt'
def main():
   global input_path
   global failed_dir
#  Reset dir_failed_path
   with open(dir_failed_path, "w") as file:
       file.write( "Failed Directories:" + "\n")
...
def dirSummary():
   ...
   with open(dir_failed_path, "a") as file:
...
def criteria_1(out_type_list,results_output):
   ...
   if len(out_type_list) == 0:
       failed_dir = True
       with open(results_output, "w") as file:
           file.write("Extra Details: \n\n")
           file.write("Dir is Empty")
   return passed
